...
typedef enum ItemProtoExtendedFlags {
    // NOTE: `extendedFlags` packs non-boolean weapon data into the
    // low nibbles (`0x0F` and `0xF0`) for attack mode metadata.
    ...
    PROTO_EXT_FLAG_LOOK = 0x2000, // Name not fully checked yet.
